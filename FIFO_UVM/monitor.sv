      ...
      forever begin
        @(posedge vif.wclk or posedge vif.rclk);
      		`uvm_info("Monitor sampling outputs",
                $sformatf("w_en=%0b | Data_in =%d | r_en=%0b | data_out=%d | full=%0b | empty=%0b",
                          vif.w_en,
                          vif.data_in,
                          vif.r_en,
                          vif.data_out,
